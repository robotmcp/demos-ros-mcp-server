...
### 9. Quadcopter Control in Gazebo

This example demonstrates how to control an **X3 quadcopter drone** in **Ignition Gazebo Fortress** through the **ROS-MCP Server**. It includes a clean minimal world with a flat floor and marker cube, plus ROS 2 bridges for arming, velocity control, odometry, TF, and clock topics.

[View Example 9](./9_quadcopter_control/README.md)
